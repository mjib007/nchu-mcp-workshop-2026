...
> 對應課綱 Segment 4「動手做（mini-project 實作）」。本節 **70 分鐘,是本工作坊的 hands-on 主場**：Segment 1–3 建立的概念，這一節要在你自己的電腦上跑起來。
>
...
| 10–25 min | L1 Step 1（觀察） + Step 2（換自己 JSON） | data/your.json |
| 25–45 min | L1 Step 3（改 docstring） + Step 4（重啟驗證） | 問你自己的資料會答 |
| 45–60 min | 交叉展示 + L2/L3 試玩：邀 3–4 位老師用自己領域資料 demo | 見識不同領域如何落地 |
| 60–70 min | Q&A + 為 L2/L3 / Segment 5 作鋪陳 | 清楚下一步 |

講師動向：10 min 講解 + 60 min 巡場陪跑 + 現場除錯（預計 80% 的時間在幫卡住的老師）。
